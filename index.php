...
<html>
	<head>
		<meta charset="utf-8">
		<meta name="description" content="Coca cola es la bebida gaseosa mas famosa">
		<meta name="keywords" content="bedida, gaseosa, cola, gasificada">
		...
		<script src="https://kit.fontawesome.com/02be98adf3.js" crossorigin="anonymous"></script>
	</head>
	<body>
		<header>
			<div class="container">
		...
		<main>
			...
			<section id="contactenos" class="seccion">
				<iframe width="520" height="400" frameborder="0" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20+(colombia)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
				<div class="container-fluid">
					<div class="row">
									...
									if($_SERVER["REQUEST_METHOD"] == "POST")
									{
										...
										if(isset($nombre))
										{
											if(isset($email))
											{
												if(isset($mensaje))
												{
													$para = "jairoahenaoramirez@hotmail.com";
													$asunto = "esto es una prueba";
													$cuerpo = $nombre."\n".$email."\n".$mensaje;
													$adicional = "Form: noreply@jairohenao.com";
			...
			<div class="container">
				<div class="row">
					...
					<div class="columna columna-25 columna-mobile-100">
						...
						<ul>
							<li>jairohenaor@gmail.com</li>
							<li>+56978692223</li>
							<li>Rudecindo ortega 0178 - Temuco <br>Araucania - Chile</li>
						</ul>	
					</div>
					<div class="columna columna-25 columna-mobile-100">
						<h3>
